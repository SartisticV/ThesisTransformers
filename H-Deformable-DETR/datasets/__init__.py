...
from .coco_vid import build as build_coco_vid
...
def build_dataset(image_set, args, test):
    if "video" in args.backbone:
        return build_coco_vid(image_set, args, test)
    elif "swin" in args.backbone:
        return build_coco(image_set, args, test)
