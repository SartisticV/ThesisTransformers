...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[1] = _summarize(1, iouThr=.25, areaRng='small', maxDets=self.params.maxDets[2])
            stats[2] = _summarize(1, iouThr=.25, areaRng='medium', maxDets=self.params.maxDets[2])
            stats[3] = _summarize(1, iouThr=.25, areaRng='large', maxDets=self.params.maxDets[2])
            ...
            stats[12] = _summarize(0, iouThr=.25, maxDets=self.params.maxDets[2])
            stats[13] = _summarize(0, iouThr=.25, areaRng='small', maxDets=self.params.maxDets[2])
            stats[14] = _summarize(0, iouThr=.25, areaRng='medium', maxDets=self.params.maxDets[2])
            stats[15] = _summarize(0, iouThr=.25, areaRng='large', maxDets=self.params.maxDets[2])
            ...
            stats[24] = _summarize(1, maxDets=self.params.maxDets[2])
