        ...
        if num_feature_levels > 1:
            ...
            for _ in range(num_backbone_outs):
                ...
                input_proj_list.append(
                    nn.Sequential(
                        nn.Conv3d(in_channels, hidden_dim, kernel_size=(3,1,1)), #2 for 3 frames, 3 for 5 frames, 5 for 9 frames
            ...
            for _ in range(num_feature_levels - num_backbone_outs):
                input_proj_list.append(
                    nn.Sequential(
                        nn.Conv3d(
                            in_channels, hidden_dim, kernel_size=3, stride=2, padding=0 # padding 1 for 3 frames, padding 0 for 5 frames, padding 0 stride 3 for 9 frames
                        ),
                        nn.Flatten(start_dim=1, end_dim=2),
                        nn.GroupNorm(32, hidden_dim),
                    )
